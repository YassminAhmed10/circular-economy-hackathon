...
namespace shadowfactory.Migrations
{
    ...
    [Migration("20260410124642_EnhanceOrderWithPaymentAndRecycler")]
    partial class EnhanceOrderWithPaymentAndRecycler
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("shadowfactory.Models.Entities.WasteAsset", b =>
                {
                    ...
                    b.Property<int>("CurrentReuseNumber")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MaxReuseCount")
                        .HasColumnType("int");

                    b.Property<int?>("PackagingWasteSubtypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PackagingWasteSubtypeId");
            ...
            modelBuilder.Entity("shadowfactory.Models.Entities.WasteListing", b =>
                {
                    ...
                    b.Property<string>("ContaminationLevel")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                    ...
                    b.Property<bool>("FoodContactSuitability")
                        .HasColumnType("bit")
                    ...
                    b.Property<string>("PackagingWasteSubtype")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                    ...
                    b.Property<string>("RecyclabilityOption")
                        .HasMaxLength(150)
            ...
            modelBuilder.Entity("shadowfactory.Models.Entities.WasteAsset", b =>
                {
                    ...
                    b.HasOne("shadowfactory.Models.Entities.PackagingWasteSubtype", "PackagingSpecialization")
                        .WithMany()
                        .HasForeignKey("PackagingWasteSubtypeId")
                        .OnDelete(DeleteBehavior.SetNull);
