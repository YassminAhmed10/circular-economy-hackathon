        ...
        private List<QuickStatDto> GetQuickStats(DashboardStatsResponse stats)
        {
            return new List<QuickStatDto>
            {
                new QuickStatDto
                {
                    ...
                    Value = $"{stats.TotalWaste:F1} طن",
                    Icon = "Package",
                    Color = "emerald",
                    Subtitle = "من إعلاناتك النشطة"
                },
                new QuickStatDto
                {
                    Title = "المشاهدات",
                ...
                new QuickStatDto
                {
                    ...
                    Value = $"{stats.TotalRevenue:N0} ج",
                    Icon = "TrendingUp",
                    Color = "amber",
                    Subtitle = "من المبيعات المكتملة"
                }
            };
        }
        ...
        public async Task<IActionResult> GetAnalytics()
        {
            try
            {
                ...
                if (user == null || !user.FactoryId.HasValue)
                {
                    ...
                    {
                        Success = false,
                        Message = "المستخدم غير موجود أو ليس لديه مصنع"
                    });
                }
