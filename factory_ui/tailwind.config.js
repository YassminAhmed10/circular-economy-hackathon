...
export default {
    ...
    plugins: [
        ...
        require('@tailwindcss/forms'), // لتحسين النماذج وإضافة أنماط افتراضية للحقول
        require('@tailwindcss/typography'), // لتحسين الطباعة وإضافة أنماط للمحتوى النصي
        require('@tailwindcss/aspect-ratio'), // لإدارة نسب الأبعاد للصور والفيديوهات

        // Note: Make sure to install all plugins using:
