                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 sticky top-24">
                            <div className="text-center mb-6">
                                ...
                                <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium ${formData.verified ? 'bg-emerald-100 text-emerald-800' : 'bg-amber-100 text-amber-800'
                                    }`}>
                                    {formData.verified ? (
                                        <>
