          ...
          {lang === 'ar' ? (
            ...
            <>
              ...
              <div className="db-col-left">
                ...
                {/* 5. Recent Activity (معروض فقط المكتملة) */}
                <div className="db-card">
                  <div className="db-ch">
                    <h3>{t.recentActivity}</h3>
                    <button className="db-cl" onClick={()=>navigate('/orders?status=completed')}>{t.viewAll} <ArrowRight size={13}/></button>
                  </div>
                  {ACTIVITIES.filter(a => a.status === 'completed').map(a=>{
                    return (
                      <div key={a.id} className="db-act">
                        <div className="db-act-ico" style={{background: dark ? 'rgba(5,150,105,.18)' : '#ecfdf5'}}>
                        ...
                        <div style={{display:'flex',flexDirection:'column',alignItems:'flex-end',gap:5}}>
                          ...
                          <span className="badge" style={{background: dark ? 'rgba(5,150,105,.18)' : '#ecfdf5', color:'#059669'}}>
                            {t.completed}
                          </span>
                        </div>
                      </div>
